...
public class Constants {
    ...
    // permissions
    public static final int PERMISSION_REQ_FINE_LOC = 1;
    public static final int PERMISSION_REQ_AUDIO_REC = 2;
    public static final int PERMISSION_REQ_WRITE_EXT = 3;
    public static final int PERMISSION_REQ_READ_EXT = 4;
    ...
    public static final String KEY_AUDIO_NAME = "key_audio_name";
